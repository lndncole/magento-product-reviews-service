...
$productEavCode = 'aov_modal_header';
...
if (!isset($attr) || !$attr->getId()) {
    $installer->addAttribute(Mage_Catalog_Model_Product::ENTITY, $productEavCode, array(
        ...
        'note'            => 'Add a header to display on the AOV modal at checkout when this product triggers the AOV modal.'
    ));
...
$categoryEavCode = 'aov_modal_cat_header';
...
if (!$attrCat->getId()) {
    $installer->addAttribute('catalog_category', $categoryEavCode,  array(
        'type'              => 'text',
        'label'             => 'AOV Cart Modal Header',
        'note'              => 'Add a header to display on the AOV modal at checkout when this category triggers the AOV modal.',
        'input'             => 'text',
        'global'            => Mage_Catalog_Model_Resource_Eav_Attribute::SCOPE_STORE,
